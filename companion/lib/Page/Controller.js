...
class PageController extends CoreBase {
	 ...
	 * @returns {Record<string, import('@companion-app/shared/Model/PageModel.js').PageModel>} the pages
	 * @access public
	 */
	getAll(clone = false) {
		if (clone) {
	 ...
	 * Set/update a page
	 * @param {number} pageNumber - the page id
	 * @param {Omit<import('@companion-app/shared/Model/PageModel.js').PageModel, 'controls'>} value - the page object containing the name
	 * @param {boolean} [redraw = false] - <code>true</code> if the graphics should invalidate
	 * @access public
	 */
	 ...
	 * @param {number} pageNumber
	 * @param {import('@companion-app/shared/Model/PageModel.js').PageModel} newValue
